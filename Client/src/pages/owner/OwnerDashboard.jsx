...
function OwnerDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        <h1 className="text-xl font-bold text-[var(--ui-text-primary)] mb-1">Dashboard</h1>
        <p className="text-[var(--ui-text-secondary)] text-sm">Welcome back! Here's an overview of your properties.</p>
      </div>
      ...
      <div className="space-y-4">
        <h2 className="text-lg font-semibold text-[var(--ui-text-primary)]">Quick Actions</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <Link to="/owner/properties/new" className="block">
            <Card variant="elevated" padding="md" hover className="h-full flex flex-col items-center justify-center text-center gap-2">
              <div className="p-3 bg-stone-100 rounded-full text-[var(--ui-text-secondary)]">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
              </div>
              <span className="text-sm font-medium text-[var(--ui-text-primary)]">Post Property</span>
            </Card>
          </Link>
          <Link to="/owner/properties" className="block">
            <Card variant="elevated" padding="md" hover className="h-full flex flex-col items-center justify-center text-center gap-2">
              <div className="p-3 bg-stone-100 rounded-full text-[var(--ui-text-secondary)]">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              ...
              <span className="text-sm font-medium text-[var(--ui-text-primary)]">My Properties</span>
            </Card>
          </Link>
          <Link to="/owner/applications" className="block">
            <Card variant="elevated" padding="md" hover className="h-full flex flex-col items-center justify-center text-center gap-2">
              <div className="p-3 bg-stone-100 rounded-full text-[var(--ui-text-secondary)]">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              ...
              <span className="text-sm font-medium text-[var(--ui-text-primary)]">Applications</span>
            </Card>
          </Link>
          <Link to="/owner/payments" className="block">
            <Card variant="elevated" padding="md" hover className="h-full flex flex-col items-center justify-center text-center gap-2">
              ...
              <span className="text-sm font-medium text-[var(--ui-text-primary)]">Payments</span>
            </Card>
          </Link>
          <Link to="/owner/messages" className="block">
            <Card variant="elevated" padding="md" hover className="h-full flex flex-col items-center justify-center text-center gap-2">
              ...
              <span className="text-sm font-medium text-[var(--ui-text-primary)]">Messages</span>
            </Card>
          </Link>
          <Link to="/owner/managers" className="block">
            <Card variant="elevated" padding="md" hover className="h-full flex flex-col items-center justify-center text-center gap-2">
              <div className="p-3 bg-stone-100 rounded-full text-[var(--ui-text-secondary)]">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              ...
              <span className="text-sm font-medium text-[var(--ui-text-primary)]">Hire Manager</span>
            </Card>
          </Link>
        </div>
      </div>
                  ...
                  >
                    <Card variant="filled" padding="sm" hover>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="ml-4">
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${property.status === 'active' ? 'bg-eucalyptus-100 text-eucalyptus-700' :
