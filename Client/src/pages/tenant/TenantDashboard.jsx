    ...
    if (loading) {
        return (
            <div className="max-w-7xl mx-auto space-y-6">
                <div className="mb-8">
                    <Skeleton variant="heading" width="40%" className="mb-2" />
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6">
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-xl font-bold text-[var(--ui-text-primary)] mb-1">Welcome back, {user?.name?.split(' ')[0]}!</h1>
                    <p className="text-[var(--ui-text-secondary)] text-sm">Here's what's happening with your rental.</p>
                </div>
