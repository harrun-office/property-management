...
function PropertyManagerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-porcelain py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-charcoal mb-2">Property Manager Dashboard</h1>
          <p className="text-architectural">Overview of your properties, vendors, and tasks</p>
        </div>
