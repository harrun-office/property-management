      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[var(--ui-text-secondary)] mb-4 text-sm leading-relaxed max-w-xs">
          ...
          {/* Product */}
          <div>
            <h3 className="text-sm font-semibold text-[var(--ui-text-primary)] uppercase tracking-wider mb-2">Product</h3>
          ...
          {/* Solutions */}
          <div>
            <h3 className="text-sm font-semibold text-[var(--ui-text-primary)] uppercase tracking-wider mb-2">Solutions</h3>
            <ul className="space-y-2">
              <li>
          ...
          {/* Support & Company */}
          <div>
            <h3 className="text-sm font-semibold text-[var(--ui-text-primary)] uppercase tracking-wider mb-2">Support</h3>
            ...
            <h3 className="text-sm font-semibold text-[var(--ui-text-primary)] uppercase tracking-wider mb-2">Company</h3>
            <ul className="space-y-2">
              <li>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[var(--ui-border-default)] pt-4">
